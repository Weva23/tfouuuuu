// Validation rules for professor form
const professorValidations = {
...
$(document).ready(function() {
    $("#add-new-prof").click(function (e) {
        ...
        // Validate form
        if (!validateFormFields('prof-add-form', professorValidations)) {
            return false;
        }
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.success) {
                    ...
                    iziToast.success({
                        title: 'Succès',
                        message: response.message || 'Professeur ajouté avec succès',
                        position: 'topRight',
                        timeout: 5000
                    });

                    // Add professor to table if provided
                    if (response.prof) {
